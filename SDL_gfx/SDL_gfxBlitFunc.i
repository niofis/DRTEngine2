# 1 "C:\\Enrique\\Programas\\MyApps\\SDL_gfx\\SDL_gfxBlitFunc.c"
# 1 "<built-in>"
# 1 "<command line>"
# 1 "C:\\Enrique\\Programas\\MyApps\\SDL_gfx\\SDL_gfxBlitFunc.c"
# 10 "C:\\Enrique\\Programas\\MyApps\\SDL_gfx\\SDL_gfxBlitFunc.c"
# 1 "C:\\Enrique\\Programas\\MyApps\\SDL_gfx\\SDL_gfxBlitFunc.h" 1
...
# 39 "C:/Enrique/Programas/SDL/SDL-devel-1.2.12-VC8/SDL-1.2.12/include/SDL_stdinc.h" 2
# 1 "C:/upp/mingw/include/stddef.h" 1
...
# 2 "C:\\Enrique\\Programas\\MyApps\\SDL_gfx\\SDL_gfxBlitFunc.h" 2
# 40 "C:\\Enrique\\Programas\\MyApps\\SDL_gfx\\SDL_gfxBlitFunc.h"
...
# 52 "C:\\Enrique\\Programas\\MyApps\\SDL_gfx\\SDL_gfxBlitFunc.h"
  typedef struct {
    Uint8 *s_pixels;
    int s_width;
    int s_height;
...
# 122 "C:\\Enrique\\Programas\\MyApps\\SDL_gfx\\SDL_gfxBlitFunc.h"
...
# 11 "C:\\Enrique\\Programas\\MyApps\\SDL_gfx\\SDL_gfxBlitFunc.c" 2
...
void SDL_gfxBlitBlitterRGBA(SDL_gfxBlitInfo * info)
{
  ...
  while (height--) {
    { int n = (width+3)/4; switch (width & 3) { case 0: do { { Uint32 pixel; unsigned sR; unsigned sG; unsigned sB; unsigned sA; unsigned dR; unsigned dG; unsigned dB; unsigned dA; unsigned sAA; do { pixel = *((Uint32 *)(src)); { sR = ((pixel&srcfmt->Rmask)>>srcfmt->Rshift)<<srcfmt->Rloss; sG = ((pixel&srcfmt->Gmask)>>srcfmt->Gshift)<<srcfmt->Gloss; sB = ((pixel&srcfmt->Bmask)>>srcfmt->Bshift)<<srcfmt->Bloss; sA = ((pixel&srcfmt->Amask)>>srcfmt->Ashift)<<srcfmt->Aloss; }; pixel &= ~srcfmt->Amask; } while(0); do { pixel = *((Uint32 *)(dst)); { dR = ((pixel&dstfmt->Rmask)>>dstfmt->Rshift)<<dstfmt->Rloss; dG = ((pixel&dstfmt->Gmask)>>dstfmt->Gshift)<<dstfmt->Gloss; dB = ((pixel&dstfmt->Bmask)>>dstfmt->Bshift)<<dstfmt->Bloss; dA = ((pixel&dstfmt->Amask)>>dstfmt->Ashift)<<dstfmt->Aloss; }; pixel &= ~dstfmt->Amask; } while(0); sAA=GFX_ALPHA_ADJUST[sA & 255]; do { dR = (((sR-dR)*(sAA))/255)+dR; dG = (((sG-dG)*(sAA))/255)+dG; dB = (((sB-dB)*(sAA))/255)+dB; } while(0); dA |= sAA; { Uint32 pixel; { pixel = ((dR>>dstfmt->Rloss)<<dstfmt->Rshift)| ((dG>>dstfmt->Gloss)<<dstfmt->Gshift)| ((dB>>dstfmt->Bloss)<<dstfmt->Bshift)| ((dA<<dstfmt->Aloss)<<dstfmt->Ashift); }; *((Uint32 *)(dst)) = pixel; }; src += srcbpp; dst += dstbpp; }; case 3: { Uint32 pixel; unsigned sR; unsigned sG; unsigned sB; unsigned sA; unsigned dR; unsigned dG; unsigned dB; unsigned dA; unsigned sAA; do { pixel = *((Uint32 *)(src)); { sR = ((pixel&srcfmt->Rmask)>>srcfmt->Rshift)<<srcfmt->Rloss; sG = ((pixel&srcfmt->Gmask)>>srcfmt->Gshift)<<srcfmt->Gloss; sB = ((pixel&srcfmt->Bmask)>>srcfmt->Bshift)<<srcfmt->Bloss; sA = ((pixel&srcfmt->Amask)>>srcfmt->Ashift)<<srcfmt->Aloss; }; pixel &= ~srcfmt->Amask; } while(0); do { pixel = *((Uint32 *)(dst)); { dR = ((pixel&dstfmt->Rmask)>>dstfmt->Rshift)<<dstfmt->Rloss; dG = ((pixel&dstfmt->Gmask)>>dstfmt->Gshift)<<dstfmt->Gloss; dB = ((pixel&dstfmt->Bmask)>>dstfmt->Bshift)<<dstfmt->Bloss; dA = ((pixel&dstfmt->Amask)>>dstfmt->Ashift)<<dstfmt->Aloss; }; pixel &= ~dstfmt->Amask; } while(0); sAA=GFX_ALPHA_ADJUST[sA & 255]; do { dR = (((sR-dR)*(sAA))/255)+dR; dG = (((sG-dG)*(sAA))/255)+dG; dB = (((sB-dB)*(sAA))/255)+dB; } while(0); dA |= sAA; { Uint32 pixel; { pixel = ((dR>>dstfmt->Rloss)<<dstfmt->Rshift)| ((dG>>dstfmt->Gloss)<<dstfmt->Gshift)| ((dB>>dstfmt->Bloss)<<dstfmt->Bshift)| ((dA<<dstfmt->Aloss)<<dstfmt->Ashift); }; *((Uint32 *)(dst)) = pixel; }; src += srcbpp; dst += dstbpp; }; case 2: { Uint32 pixel; unsigned sR; unsigned sG; unsigned sB; unsigned sA; unsigned dR; unsigned dG; unsigned dB; unsigned dA; unsigned sAA; do { pixel = *((Uint32 *)(src)); { sR = ((pixel&srcfmt->Rmask)>>srcfmt->Rshift)<<srcfmt->Rloss; sG = ((pixel&srcfmt->Gmask)>>srcfmt->Gshift)<<srcfmt->Gloss; sB = ((pixel&srcfmt->Bmask)>>srcfmt->Bshift)<<srcfmt->Bloss; sA = ((pixel&srcfmt->Amask)>>srcfmt->Ashift)<<srcfmt->Aloss; }; pixel &= ~srcfmt->Amask; } while(0); do { pixel = *((Uint32 *)(dst)); { dR = ((pixel&dstfmt->Rmask)>>dstfmt->Rshift)<<dstfmt->Rloss; dG = ((pixel&dstfmt->Gmask)>>dstfmt->Gshift)<<dstfmt->Gloss; dB = ((pixel&dstfmt->Bmask)>>dstfmt->Bshift)<<dstfmt->Bloss; dA = ((pixel&dstfmt->Amask)>>dstfmt->Ashift)<<dstfmt->Aloss; }; pixel &= ~dstfmt->Amask; } while(0); sAA=GFX_ALPHA_ADJUST[sA & 255]; do { dR = (((sR-dR)*(sAA))/255)+dR; dG = (((sG-dG)*(sAA))/255)+dG; dB = (((sB-dB)*(sAA))/255)+dB; } while(0); dA |= sAA; { Uint32 pixel; { pixel = ((dR>>dstfmt->Rloss)<<dstfmt->Rshift)| ((dG>>dstfmt->Gloss)<<dstfmt->Gshift)| ((dB>>dstfmt->Bloss)<<dstfmt->Bshift)| ((dA<<dstfmt->Aloss)<<dstfmt->Ashift); }; *((Uint32 *)(dst)) = pixel; }; src += srcbpp; dst += dstbpp; }; case 1: { Uint32 pixel; unsigned sR; unsigned sG; unsigned sB; unsigned sA; unsigned dR; unsigned dG; unsigned dB; unsigned dA; unsigned sAA; do { pixel = *((Uint32 *)(src)); { sR = ((pixel&srcfmt->Rmask)>>srcfmt->Rshift)<<srcfmt->Rloss; sG = ((pixel&srcfmt->Gmask)>>srcfmt->Gshift)<<srcfmt->Gloss; sB = ((pixel&srcfmt->Bmask)>>srcfmt->Bshift)<<srcfmt->Bloss; sA = ((pixel&srcfmt->Amask)>>srcfmt->Ashift)<<srcfmt->Aloss; }; pixel &= ~srcfmt->Amask; } while(0); do { pixel = *((Uint32 *)(dst)); { dR = ((pixel&dstfmt->Rmask)>>dstfmt->Rshift)<<dstfmt->Rloss; dG = ((pixel&dstfmt->Gmask)>>dstfmt->Gshift)<<dstfmt->Gloss; dB = ((pixel&dstfmt->Bmask)>>dstfmt->Bshift)<<dstfmt->Bloss; dA = ((pixel&dstfmt->Amask)>>dstfmt->Ashift)<<dstfmt->Aloss; }; pixel &= ~dstfmt->Amask; } while(0); sAA=GFX_ALPHA_ADJUST[sA & 255]; do { dR = (((sR-dR)*(sAA))/255)+dR; dG = (((sG-dG)*(sAA))/255)+dG; dB = (((sB-dB)*(sAA))/255)+dB; } while(0); dA |= sAA; { Uint32 pixel; { pixel = ((dR>>dstfmt->Rloss)<<dstfmt->Rshift)| ((dG>>dstfmt->Gloss)<<dstfmt->Gshift)| ((dB>>dstfmt->Bloss)<<dstfmt->Bshift)| ((dA<<dstfmt->Aloss)<<dstfmt->Ashift); }; *((Uint32 *)(dst)) = pixel; }; src += srcbpp; dst += dstbpp; }; } while ( --n > 0 ); } };
# 47 "C:\\Enrique\\Programas\\MyApps\\SDL_gfx\\SDL_gfxBlitFunc.c"
    src += srcskip;
    dst += dstskip;
  }
}
